...
public final class MazeBugRunner {
    ...
    public static void main(String[] args) {
        ...
        /*
         * world.add(new Location(-1,-1),new MazeBug()); for(int i=0;i<=40;i++){
         * for(int j=0;j<=40;j+=40){ world.add(new Location(i,j),new Rock()); }
         * } for(int i=0;i<=40;i+=40){ for(int j=0;j<=40;j++){ world.add(new
         * Location(i,j),new Rock()); } }
         */
